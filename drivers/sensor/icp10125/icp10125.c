...
{
	/* Since there is no detailed description in the ICP 10125 product manual,
    the calculation of the pressure implement as same as show in the sample code. */
...
/**
 * @brief Calculates the pressure value in pascals from the stored data.
 * Since there is no detailed description in the ICP 10125 product manual,
 * the calculation of the pressure implement as same as show in the sample code.
 * @param data icp10125 sensor data
...
/**
 * @brief Reads the calibration value from OTP memory and stores it in the icp10125_data.
 * The meaning of the values in the OTP memory are not explained
 * in the manual, so I use it as in the sample code as well.
 */
