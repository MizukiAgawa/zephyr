...
static float icp10125_calc_caribrated_ambient_temp(const struct icp10125_data *data)
{
	return -45.f + 175.f / 65536.f * data->raw_ambient_temp;
}

static float icp10125_calc_caribrated_press(const struct icp10125_data *data)
{
...
{
	sensor_value_from_double(val, icp10125_calc_caribrated_press(data) / 1000.f);
}

static void icp10125_convert_ambient_temp_value(struct icp10125_data *data,
						struct sensor_value *val)
{
	sensor_value_from_double(val, icp10125_calc_caribrated_ambient_temp(data));
}
